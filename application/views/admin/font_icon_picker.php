...
<select name="icon" class="form-control custom-select">
    <option value='fa-500px' <?php if (isset($module)) if ($module->icon == 'fa-500px') echo "selected" ?>>&#xf26e; fa-500px</option>
    <option value='fa-address-book' <?php if (isset($module)) if ($module->icon == 'fa-address-book') echo "selected" ?>>&#xf2b9; fa-address-book</option>
    <option value='fa-address-book-o' <?php if (isset($module)) if ($module->icon == 'fa-address-book-o') echo "selected" ?>>&#xf2ba; fa-address-book-o</option>
    <option value='fa-address-card' <?php if (isset($module)) if ($module->icon == 'fa-address-card') echo "selected" ?>>&#xf2bb; fa-address-card</option>
    <option value='fa-address-card-o' <?php if (isset($module)) if ($module->icon == 'fa-address-card-o') echo "selected" ?>>&#xf2bc; fa-address-card-o</option>
    <option value='fa-adjust' <?php if (isset($module)) if ($module->icon == 'fa-adjust') echo "selected" ?>>&#xf042; fa-adjust</option>


    <option value='fa-adn' <?php if (isset($module)) if ($module->icon == 'fa-adjust') echo "selected" ?>>&#xf170; fa-adn</option>
    <option value='fa-align-center' <?php if (isset($module)) if ($module->icon == 'fa-adjust') echo "selected" ?>>&#xf037; fa-align-center</option>
    ...
    <option value='fa-battery-three-quarters'>&#xf241; fa-battery-three-quarters
    </option>
    ...
    <option value='fa-caret-square-o-right'>&#xf152; fa-caret-square-o-right
    </option>
    ...
    <option value='fa-chevron-circle-right'>&#xf138; fa-chevron-circle-right
    </option>
    ...
    <option value='fa-google-plus-official'>&#xf2b3; fa-google-plus-official
    </option>
    ...
    <option value='fa-odnoklassniki-square'>&#xf264; fa-odnoklassniki-square
    </option>
    ...
    <option value='fa-youtube-square' <?php if (isset($module)) if ($module->icon == 'fa-youtube-square') echo "selected" ?>>&#xf166; fa-youtube-square</option>
</select>
